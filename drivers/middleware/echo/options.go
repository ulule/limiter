...
type LimitReachedHandler func(c echo.Context) error
...
func DefaultLimitReachedHandler(c echo.Context) error {
	return c.String(http.StatusTooManyRequests, "Limit exceeded")
}
